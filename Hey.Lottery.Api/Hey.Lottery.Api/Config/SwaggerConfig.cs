using Hey.Lottery.Api.SwaggerExtensions;
    ...
    public class SwaggerConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            config.EnableSwagger(c =>
            {
                ...
                c.IncludeXmlComments($"{ System.AppDomain.CurrentDomain.BaseDirectory}/{typeof(BaseRequest).Assembly.GetName().Name}.XML");
